...
public class Cell extends JComponent {
    ...
    public static final int STATE_MASKED_INFECTED = 6;
    ...
    public Cell(int id) {
        ...
        if (imageDictionary == null) {
            ...
            imageDictionary.put(STATE_MASKED_INFECTED, ImageHelper.fromResource("masked.png"));
            ...
            colorDictionary.put(STATE_MASKED_INFECTED, Color.decode("#f50e0e"));
        }
